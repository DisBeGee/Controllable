...
public class ControllerButton extends AbstractGui
{
    ...
    public void draw(int x, int y, int mouseX, int mouseY)
    {
        ...
        Minecraft.getInstance().getTextureManager().bindTexture(GuiControllerLayout.TEXTURE);
        int buttonV = v;
        ...
        blit(buttonX, buttonY, u, buttonV, this.width, this.height, this.width * this.scale, this.height * this.scale, 256, 256);
